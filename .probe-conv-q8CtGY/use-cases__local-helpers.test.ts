...
import { transpile } from '/Users/tonioloewald/tjs-lang/src/lang'

import { AgentVM } from '/Users/tonioloewald/tjs-lang/src/vm'

describe('Local helper functions', () => {
  const VM = new AgentVM()
  const run = async (src, args) => (await VM.run(ajs(src), args)).result
  ...
  const expectTranspileError = (src, match) =>
