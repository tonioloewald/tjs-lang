...
import {
  ...
  JSDELIVR,
  ESM_SH,
} from '/Users/tonioloewald/tjs-lang/src/import-resolver/resolve'
...
describe('extractImports (migrated from demo/src/imports.test.ts)', () => {
  ...
  it('ignores relative imports', () => {
    expect(
      extractImports(
        `import { a } from '/Users/tonioloewald/tjs-lang/src/import-resolver/local'\nimport { b } from 'pkg'`
      )
    ).toEqual(['pkg'])
  })
...
describe('rewriteImports (migrated + prefix-parametrized)', () => {
  ...
  it('leaves relative, absolute, and http(s) imports alone', () => {
    for (const src of [
      `import { x } from '/Users/tonioloewald/tjs-lang/src/import-resolver/local'`,
...
describe('rewriteEsmShBody', () => {
  ...
  it('leaves non-root-relative specifiers alone', () => {
    const src = `import x from "/Users/tonioloewald/tjs-lang/src/import-resolver/sibling.js"; import y from "https://esm.sh/z";`
...
describe('built worker (anti-drift smoke)', () => {
  const workerPath = join(
    '/Users/tonioloewald/tjs-lang/src/import-resolver',
    '..',
    '..',
    'dist',
