...
function greet(name: 'world') {
  ...
  describe('ES Module support (import/export)', () => {
    ...
    it('should preserve multiple imports', () => {
      const result = transpileToJS(`
        import { add, subtract } from '/Users/tonioloewald/tjs-lang/src/lang/math.tjs'
    ...
    it('should handle mixed imports, exports, and regular functions', () => {
      const result = transpileToJS(
        `
        import { helper } from '/Users/tonioloewald/tjs-lang/src/lang/utils.tjs'
    ...
    it('should preserve import * as syntax', () => {
      const result = transpileToJS(`
        import * as math from '/Users/tonioloewald/tjs-lang/src/lang/math.tjs'
        function main() {
          return math.add(1, 2)
        }
      `)
    ...
    it('should preserve default import syntax', () => {
      const result = transpileToJS(`
        import Calculator from '/Users/tonioloewald/tjs-lang/src/lang/calc.tjs'
        function main() {
