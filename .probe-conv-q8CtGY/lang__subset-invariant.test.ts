...
import { tjs, transpile } from '/Users/tonioloewald/tjs-lang/src/lang/index'
...
describe('Language subset invariants (PRINCIPLES.md)', () => {
  ...
  it('un-runnable signature tests are inconclusive, not failures', () => {
    ...
    const sig = r.testResults?.find((t) => t.isSignatureTest)
