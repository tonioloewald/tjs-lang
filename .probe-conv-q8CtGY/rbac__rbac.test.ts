...
import { createMemoryStore } from '/Users/tonioloewald/tjs-lang/src/store/memory'

import { createRBAC } from '/Users/tonioloewald/tjs-lang/src/rbac/index'
  ...
  describe('Schema validation', () => {
    ...
    test('validates field types', async () => {
      ...
      const invalid = await rbac.check({
        ...
        method: 'write',
        collection: 'posts',
        newData: { title: 'Hello', views: 'many' },
      })
      expect(valid.allowed).toBe(true)
      expect(invalid.allowed).toBe(false)
