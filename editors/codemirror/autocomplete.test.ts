...
`)
  ...
  return a + b
      ...
      expect(metadata?.params?.a?.type?.kind).toBe('number')
      expect(metadata?.params?.b?.type?.kind).toBe('number')
    })
  ...
  return 'Hello ' + name
      ...
      expect(metadata?.params?.times?.type?.kind).toBe('number')
      expect(metadata?.params?.times?.default).toBe(1)
    })
